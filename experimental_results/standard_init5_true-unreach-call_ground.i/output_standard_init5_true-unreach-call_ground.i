>>> prove_auto('standard_init5_true-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
Successfully Proved
ForAll([_n5],Implies(_n5>=0,d1array12(a, _n5, 0) == 46))
Successfully Proved
ForAll([_n5],Implies(_n5>=0,Implies((d1array12(a, _n5, _k6 + 1)==46),(d1array12(a, _n5, _k6 + 2)==46))))
Successfully Proved
