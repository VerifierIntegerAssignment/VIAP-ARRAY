...
_s.add(ForAll([_x2],Implies(_x2>=0,d1array5(a, _x2, _N2) == d1array(a, _x2))))
_s.add(a1 == a)
_s.add(i1 == _N1)
_s.add(x1 == _N2)
_s.add(ForAll([_x2,_x1],Implies(_x2>=0,d1array1(_x1, _x2) == d1array5(_x1, _x2, _N2))))
