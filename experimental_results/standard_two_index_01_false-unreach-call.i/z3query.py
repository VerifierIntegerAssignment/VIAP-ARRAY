...
_s.add(j1 == _N2)
_s.add(main == 0)
_s.add(ForAll([_n1],Implies(_n1>=0,d1array3(a, _n1, _n1 + 1) == d1array3(b, _n1, _n1))))
...
_s.add(_N2 >= 10000)
_s.add(ForAll([_n2],Implies(And(_n2 < _N2,_n2>=0),_f(_n2) < 10000)))
_s.add(Or(_N2==0,_N2 - 1 < 10000))
_s.add(ForAll([_n1],Implies(_n1>=0,d1array3(a, _n1, _N1) == d1array3(b, _n1, _N1))))
_s.add(ForAll([_x2],Implies(_x2>=0,d1array3(b, _x2, _N1) == d1array(b, _x2))))
_s.add(ForAll([_n1],Implies(_n1>=0,d1array6(a, _n1, _N2) == d1array3(b, _n1, _N1))))
