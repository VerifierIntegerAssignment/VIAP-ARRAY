...
_s.add(ForAll([_x2],Implies(_x2>=0,d1array5(b, _x2, _N2) == d1array(b, _x2))))
_s.add(a1 == a)
_s.add(b1 == b)
_s.add(i1 == _N1)
_s.add(x1 == If(rv3(_N1) > 0,_N2,x))
