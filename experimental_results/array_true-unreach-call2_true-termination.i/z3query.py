...
_s.add(i1 == _N1)
_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(B, _x2) == d1array3(B, _x2, _N1))))
_s.add(main == 0)
_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(A, _x2) == d1array3(A, _x2, _N1))))
_s.add(ForAll([_n1],Implies(_n1>=0,tmp3(_n1 + 1) == d1array3(A, _n1, _n1))))
_s.add(ForAll([_x2,_n1],Implies(And(_x2>=0,_n1>=0),d1array3(A, _x2, _n1 + 1) == d1array3(A, _x2, _n1))))
_s.add(ForAll([_n1],Implies(_n1>=0,d1array3(B, _n1, _n1 + 1) == d1array3(A, _n1, _n1))))
_s.add(tmp3(0) == tmp)
...
_s.add(ForAll([_x2],Implies(_x2>=0,d1array3(A, _x2, _N1) == d1array(A, _x2))))
_s.add(ForAll([_n1],Implies(_n1>=0,d1array3(B, _n1, _N1) == d1array3(A, _n1, _N1))))
_s.add(A1 == A)
_s.add(B1 == B)
_s.add(_k1>=0)
_s.add(_N1>=0)
