>>> prove_auto('standard_copy5_false-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
(= (d1array8 _x1 _x2 (+ _n4 1)) (ite (and (= _x1 a6_var) (= _x2 (+ _n4 0))) (d1array8 a4_var (+ _n4 0) _n4) (d1array8 _x1 _x2 _n4)))
...
d1array8(_x1,_x2,(_n4+1)) = ite(((_x1=a6_var) and (_x2=(_n4+0))),d1array8(a4_var,(_n4+0),_n4),d1array8(_x1,_x2,_n4))
d1array8(_x1,_x2,0) = d1array6(_x1,_x2,_N3)
(_N4>=(-(0)+100000))
...
Successfully Proved
d1array8(a6_var, 0, 1) == d1array8(a4_var, 0, 0)
Successfully Proved
Implies((d1array8(a6_var, _k4, _k4 + 1)==d1array8(a4_var, _k4, _k4)),(d1array8(a6_var, _k4 + 1, _k4 + 2)==d1array8(a4_var, _k4 + 1, _k4 + 1)))
Successfully Proved
Implies(ForAll([_n4],Implies(And(And(_n4>=0,_n4<_L4),_L4>0),d1array8(a6_var, _n4, _n4 + 1) == d1array8(a4_var, _n4, _n4))),ForAll([_n4],Implies(And(And(And(And(_n4>=0,_n4<_L4),_L4>0),_n4<_L4+1),_L4>0),d1array8(a6_var, _n4, _n4 + 1) == d1array8(a4_var, _n4, _n4))))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array8(a5_var, _x2, 0) == d1array(a5_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array8(a5_var, _x2, _k4 + 1)==d1array(a5_var, _x2)),(d1array8(a5_var, _x2, _k4 + 2)==d1array(a5_var, _x2)))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array10(a5_var, _x2, 0) == d1array(a5_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array10(a5_var, _x2, _k5 + 1)==d1array(a5_var, _x2)),(d1array10(a5_var, _x2, _k5 + 2)==d1array(a5_var, _x2)))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array12(a5_var, _x2, 0) == d1array(a5_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array12(a5_var, _x2, _k6 + 1)==d1array(a5_var, _x2)),(d1array12(a5_var, _x2, _k6 + 2)==d1array(a5_var, _x2)))))
Successfully Proved
...
d1array8(a6_var,(_n4+0),_N4) = d1array8(a4_var,(_n4+0),_N4)
...
d1array10(a5_var,_x2,_N5) = d1array(a5_var,_x2)
...
d1array12(a5_var,_x2,_N6) = d1array(a5_var,_x2)
