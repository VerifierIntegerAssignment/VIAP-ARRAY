...
_s.add(b1 == b)
_s.add(i1 == 9*_N2 + 1)
_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a, _x2) == d1array6(a, _x2, _N2))))
_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(b, _x2) == d1array6(b, _x2, _N2))))
_s.add(j1 == _N2)
_s.add(main == 0)
_s.add(ForAll([_n1],Implies(_n1>=0,d1array3(a, _n1, _n1 + 1) == d1array3(b, 9*_n1 + 1, _n1))))
_s.add(ForAll([_x2,_n1],Implies(And(_x2>=0,_n1>=0),d1array3(b, _x2, _n1 + 1) == d1array3(b, _x2, _n1))))
_s.add(ForAll([_x2],Implies(_x2>=0,d1array3(a, _x2, 0) == d1array(a, _x2))))
_s.add(ForAll([_x2],Implies(_x2>=0,d1array3(b, _x2, 0) == d1array(b, _x2))))
_s.add((_N1>=(((-1)/(9))+((100000)/(9)))))
_s.add(ForAll([_n1],Implies(And(_n1 < _N1,_n1>=0),9*_f(_n1) + 1 < 100000)))
_s.add(Or(_N1==0,9*_N1 - 8 < 100000))
