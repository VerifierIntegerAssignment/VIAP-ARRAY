...
_s.add(j1 == _N2)
_s.add(main == 0)
_s.add(ForAll([_n1],Implies(_n1>=0,d1array3(a, _n1, _n1 + 1) == d1array3(b, 5*_n1 + 1, _n1))))
...
_s.add((_N1>=(((-1)/(5))+20000)))
_s.add(ForAll([_n1],Implies(And(_n1 < _N1,_n1>=0),5*_f(_n1) + 1 < 100000)))
_s.add(Or(_N1==0,5*_N1 - 4 < 100000))
...
_s.add(ForAll([_n1],Implies(_n1>=0,d1array3(a, _n1, _N1) == d1array3(b, 5*_n1 + 1, _N1))))
_s.add(ForAll([_x2],Implies(_x2>=0,d1array3(b, _x2, _N1) == d1array(b, _x2))))
_s.add(ForAll([_n1],Implies(_n1>=0,d1array6(a, _n1, _N2) == d1array3(b, 5*_n1 + 1, _N1))))
