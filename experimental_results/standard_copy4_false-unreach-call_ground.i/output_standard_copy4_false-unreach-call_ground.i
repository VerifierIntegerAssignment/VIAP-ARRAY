>>> prove_auto('standard_copy4_false-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
{}
Local Variables:
{ a3_var:array a1_var:array i:int _1_PROVE:array RET:int a4_var:array a2_var:array a5_var:array x:int}
Program Body
{
  int RET = 0;
  int _1_FAILED = 0;
...
(= (d1array6 _x1 _x2 (+ _n3 1)) (ite (and (= _x1 a5_var) (= _x2 (+ _n3 0))) (d1array6 a3_var (+ _n3 0) _n3) (d1array6 _x1 _x2 _n3)))
...
d1array6(_x1,_x2,(_n3+1)) = ite(((_x1=a5_var) and (_x2=(_n3+0))),d1array6(a3_var,(_n3+0),_n3),d1array6(_x1,_x2,_n3))
d1array6(_x1,_x2,0) = d1array4(_x1,_x2,_N2)
(_N3>=(-(0)+100000))
...
5. Assertion :
(d1array10(a1_var,(_n5+0),_N5)==d1array10(a5_var,(_n5+0),_N5))
...
Successfully Proved
d1array6(a5_var, 0, 1) == d1array6(a3_var, 0, 0)
Successfully Proved
Implies((d1array6(a5_var, _k3, _k3 + 1)==d1array6(a3_var, _k3, _k3)),(d1array6(a5_var, _k3 + 1, _k3 + 2)==d1array6(a3_var, _k3 + 1, _k3 + 1)))
Successfully Proved
Implies(ForAll([_n3],Implies(And(And(_n3>=0,_n3<_L3),_L3>0),d1array6(a5_var, _n3, _n3 + 1) == d1array6(a3_var, _n3, _n3))),ForAll([_n3],Implies(And(And(And(And(_n3>=0,_n3<_L3),_L3>0),_n3<_L3+1),_L3>0),d1array6(a5_var, _n3, _n3 + 1) == d1array6(a3_var, _n3, _n3))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array6(a4_var, _x2, 0) == d1array(a4_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array6(a4_var, _x2, _k3 + 1)==d1array(a4_var, _x2)),(d1array6(a4_var, _x2, _k3 + 2)==d1array(a4_var, _x2)))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array8(a4_var, _x2, 0) == d1array(a4_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array8(a4_var, _x2, _k4 + 1)==d1array(a4_var, _x2)),(d1array8(a4_var, _x2, _k4 + 2)==d1array(a4_var, _x2)))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array10(a4_var, _x2, 0) == d1array(a4_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array10(a4_var, _x2, _k5 + 1)==d1array(a4_var, _x2)),(d1array10(a4_var, _x2, _k5 + 2)==d1array(a4_var, _x2)))))
Successfully Proved
...
d1array6(a5_var,(_n3+0),_N3) = d1array6(a3_var,(_n3+0),_N3)
...
d1array8(a4_var,_x2,_N4) = d1array(a4_var,_x2)
...
d1array10(a4_var,_x2,_N5) = d1array(a4_var,_x2)
