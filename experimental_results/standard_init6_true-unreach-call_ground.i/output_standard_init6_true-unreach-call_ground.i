>>> prove_auto('standard_init6_true-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
Successfully Proved
ForAll([_n6],Implies(_n6>=0,d1array14(a, _n6, 0) == 47))
Successfully Proved
ForAll([_n6],Implies(_n6>=0,Implies((d1array14(a, _n6, _k7 + 1)==47),(d1array14(a, _n6, _k7 + 2)==47))))
Successfully Proved
