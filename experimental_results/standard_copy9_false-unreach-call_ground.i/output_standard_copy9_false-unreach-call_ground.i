>>> prove_auto('standard_copy9_false-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
(= (d1array16 _x1 _x2 (+ _n8 1)) (ite (and (= _x1 a0_var) (= _x2 (+ _n8 0))) (d1array16 a8_var (+ _n8 0) _n8) (d1array16 _x1 _x2 _n8)))
...
d1array16(_x1,_x2,(_n8+1)) = ite(((_x1=a0_var) and (_x2=(_n8+0))),d1array16(a8_var,(_n8+0),_n8),d1array16(_x1,_x2,_n8))
d1array16(_x1,_x2,0) = d1array14(_x1,_x2,_N7)
(_N8>=(-(0)+100000))
...
Successfully Proved
d1array16(a0_var, 0, 1) == d1array16(a8_var, 0, 0)
Successfully Proved
Implies((d1array16(a0_var, _k8, _k8 + 1)==d1array16(a8_var, _k8, _k8)),(d1array16(a0_var, _k8 + 1, _k8 + 2)==d1array16(a8_var, _k8 + 1, _k8 + 1)))
Successfully Proved
Implies(ForAll([_n8],Implies(And(And(_n8>=0,_n8<_L8),_L8>0),d1array16(a0_var, _n8, _n8 + 1) == d1array16(a8_var, _n8, _n8))),ForAll([_n8],Implies(And(And(And(And(_n8>=0,_n8<_L8),_L8>0),_n8<_L8+1),_L8>0),d1array16(a0_var, _n8, _n8 + 1) == d1array16(a8_var, _n8, _n8))))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array16(a9_var, _x2, 0) == d1array(a9_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array16(a9_var, _x2, _k8 + 1)==d1array(a9_var, _x2)),(d1array16(a9_var, _x2, _k8 + 2)==d1array(a9_var, _x2)))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array18(a9_var, _x2, 0) == d1array(a9_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array18(a9_var, _x2, _k9 + 1)==d1array(a9_var, _x2)),(d1array18(a9_var, _x2, _k9 + 2)==d1array(a9_var, _x2)))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array20(a9_var, _x2, 0) == d1array(a9_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array20(a9_var, _x2, _k10 + 1)==d1array(a9_var, _x2)),(d1array20(a9_var, _x2, _k10 + 2)==d1array(a9_var, _x2)))))
Successfully Proved
...
d1array16(a0_var,(_n8+0),_N8) = d1array16(a8_var,(_n8+0),_N8)
d1array16(a9_var,_x2,_N8) = d1array(a9_var,_x2)
...
d1array18(a9_var,_x2,_N9) = d1array(a9_var,_x2)
...
d1array20(a9_var,_x2,_N10) = d1array(a9_var,_x2)
