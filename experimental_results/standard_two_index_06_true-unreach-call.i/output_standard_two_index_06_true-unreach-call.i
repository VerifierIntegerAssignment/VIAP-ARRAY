>>> file_name='experiment/array-examples/standard_two_index_06_true-unreach-call.i'
...
3. Other axioms:
(= (d1array3 _x1 _x2 (+ _n1 1)) (ite (and (= _x1 a) (= _x2 (+ _n1 0))) (d1array3 b (+ (* 6 _n1) 1) _n1) (d1array3 _x1 _x2 _n1)))
(= (d1array3 _x1 _x2 0) (d1array _x1 _x2))
(>= _N1 (+ (/ (- 1) 6) (/ 5000 3)))
(implies (< _n1 _N1) (< (+ (* 6 _n1) 1) 10000))
(= (d1array6 _x1 _x2 (+ _n2 1)) (d1array6 _x1 _x2 _n2))
(= (d1array6 _x1 _x2 0) (d1array3 _x1 _x2 _N1))
(>= _N2 (+ (/ (- 1) 6) (/ 5000 3)))
(implies (< _n2 _N2) (< (+ (* 6 _n2) 1) 10000))
...
Successfully Proved
Implies((d1array3(a, _k1, _k1 + 1)==d1array3(b, 6*_k1 + 1, _k1)),(d1array3(a, _k1 + 1, _k1 + 2)==d1array3(b, 6*_k1 + 7, _k1 + 1)))
Successfully Proved
Implies(ForAll([_n1],Implies(And(And(_n1>=0,_n1<_L1),_L1>0),d1array3(a, _n1, _n1 + 1) == d1array3(b, 6*_n1 + 1, _n1))),ForAll([_n1],Implies(And(And(And(And(_n1>=0,_n1<_L1),_L1>0),_n1<_L1+1),_L1>0),d1array3(a, _n1, _n1 + 1) == d1array3(b, 6*_n1 + 1, _n1))))
Successfully Proved
...
Successfully Proved
ForAll([_n1],Implies(_n1>=0,d1array6(a, _n1, 0) == d1array3(b, 6*_n1 + 1, _N1)))
Successfully Proved
ForAll([_n1],Implies(_n1>=0,Implies((d1array6(a, _n1, _k2 + 1)==d1array3(b, 6*_n1 + 1, _N1)),(d1array6(a, _n1, _k2 + 2)==d1array3(b, 6*_n1 + 1, _N1)))))
Successfully Proved
...
d1array3(a,(_n1+0),_N1) = d1array3(b,((6*_n1)+1),_N1)
d1array3(b,_x2,_N1) = d1array(b,_x2)
d1array6(a,(_n1+0),_N2) = d1array3(b,((6*_n1)+1),_N1)
