...
_s.add(ForAll([_n4],Implies(_n4>=0,_N3(_n4) >= __VERIFIER_nondet_int)))
_s.add(ForAll([_n4,_n3],Implies(And(_n3 < _N3(_n4),And(_n4>=0,_n3>=0)),_f(_n3) < __VERIFIER_nondet_int)))
_s.add(ForAll([_n4],Implies(_n4>=0,Or(_N3(_n4)==0,_N3(_n4) - 1 < __VERIFIER_nondet_int))))
...
_s.add(_N4 >= __VERIFIER_nondet_int)
_s.add(ForAll([_n4],Implies(And(_n4 < _N4,_n4>=0),_f(_n4) < __VERIFIER_nondet_int)))
_s.add(Or(_N4==0,_N4 - 1 < __VERIFIER_nondet_int))
_s.add(ForAll([_x3,_x2,_n2],Implies(And(_x3>=0,And(_x2>=0,_n2>=0)),d2array5(A, _x2, _x3, _n2 + 1) == d2array2(A, _x2, _x3, _N1(_n2), _n2))))
