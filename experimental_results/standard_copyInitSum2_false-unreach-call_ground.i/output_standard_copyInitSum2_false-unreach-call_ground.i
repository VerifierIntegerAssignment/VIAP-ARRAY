>>> prove_auto('standard_copyInitSum2_false-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
(= (d1array6 _x1 _x2 (+ _n3 1)) (ite (and (= _x1 a) (= _x2 (+ _n3 0))) (+ (d1array6 b (+ _n3 0) _n3) (+ _n3 0)) (d1array6 _x1 _x2 _n3)))
...
d1array6(_x1,_x2,(_n3+1)) = ite(((_x1=a) and (_x2=(_n3+0))),(d1array6(b,(_n3+0),_n3)+(_n3+0)),d1array6(_x1,_x2,_n3))
d1array6(_x1,_x2,0) = d1array4(_x1,_x2,_N2)
(_N3>=(-(0)+100000))
...
Successfully Proved
d1array6(a, 0, 1) == d1array6(b, 0, 0)
Successfully Proved
Implies((d1array6(a, _k3, _k3 + 1)==_k3 + d1array6(b, _k3, _k3)),(d1array6(a, _k3 + 1, _k3 + 2)==_k3 + d1array6(b, _k3 + 1, _k3 + 1) + 1))
Successfully Proved
Implies(ForAll([_n3],Implies(And(And(_n3>=0,_n3<_L3),_L3>0),d1array6(a, _n3, _n3 + 1) == _n3 + d1array6(b, _n3, _n3))),ForAll([_n3],Implies(And(And(And(And(_n3>=0,_n3<_L3),_L3>0),_n3<_L3+1),_L3>0),d1array6(a, _n3, _n3 + 1) == _n3 + d1array6(b, _n3, _n3))))
Successfully Proved
...
Successfully Proved
ForAll([_n3],Implies(_n3>=0,d1array8(a, _n3, 0) == _n3 + d1array6(b, _n3, _N3)))
Successfully Proved
ForAll([_n3],Implies(_n3>=0,Implies((d1array8(a, _n3, _k4 + 1)==_n3 + d1array6(b, _n3, _N3)),(d1array8(a, _n3, _k4 + 2)==_n3 + d1array6(b, _n3, _N3)))))
Successfully Proved
ForAll([_n2],Implies(_n2>=0,d1array8(b, _n2, 0) == d1array4(a, _n2, _N2)))
Successfully Proved
ForAll([_n2],Implies(_n2>=0,Implies((d1array8(b, _n2, _k4 + 1)==d1array4(a, _n2, _N2)),(d1array8(b, _n2, _k4 + 2)==d1array4(a, _n2, _N2)))))
Successfully Proved
...
d1array6(a,(_n3+0),_N3) = (d1array6(b,(_n3+0),_N3)+(_n3+0))
d1array6(b,(_n2+0),_N3) = d1array4(a,(_n2+0),_N2)
d1array8(a,(_n3+0),_N4) = (d1array6(b,(_n3+0),_N3)+(_n3+0))
d1array8(b,(_n2+0),_N4) = d1array4(a,(_n2+0),_N2)
