>>> prove_auto('standard_init4_true-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
Successfully Proved
ForAll([_n4],Implies(_n4>=0,d1array10(a, _n4, 0) == 45))
Successfully Proved
ForAll([_n4],Implies(_n4>=0,Implies((d1array10(a, _n4, _k5 + 1)==45),(d1array10(a, _n4, _k5 + 2)==45))))
Successfully Proved
