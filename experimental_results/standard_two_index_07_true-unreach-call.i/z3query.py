...
_s.add(j1 == _N2)
_s.add(main == 0)
_s.add(ForAll([_n1],Implies(_n1>=0,d1array3(a, _n1, _n1 + 1) == d1array3(b, 7*_n1 + 1, _n1))))
...
_s.add((_N1>=(((-1)/(7))+((100000)/(7)))))
_s.add(ForAll([_n1],Implies(And(_n1 < _N1,_n1>=0),7*_f(_n1) + 1 < 100000)))
_s.add(Or(_N1==0,7*_N1 - 6 < 100000))
