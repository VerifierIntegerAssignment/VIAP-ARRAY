>>> prove_auto('standard_copy8_false-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
{}
Local Variables:
{ a7_var:array a8_var:array a3_var:array a1_var:array i:int _1_PROVE:array RET:int a4_var:array a2_var:array a5_var:array x:int a6_var:array a9_var:array}
Program Body
{
  int RET = 0;
  int _1_FAILED = 0;
...
(= (d1array14 _x1 _x2 (+ _n7 1)) (ite (and (= _x1 a9_var) (= _x2 (+ _n7 0))) (d1array14 a7_var (+ _n7 0) _n7) (d1array14 _x1 _x2 _n7)))
...
d1array14(_x1,_x2,(_n7+1)) = ite(((_x1=a9_var) and (_x2=(_n7+0))),d1array14(a7_var,(_n7+0),_n7),d1array14(_x1,_x2,_n7))
d1array14(_x1,_x2,0) = d1array12(_x1,_x2,_N6)
(_N7>=(-(0)+100000))
...
5. Assertion :
(d1array18(a1_var,(_n9+0),_N9)==d1array18(a9_var,(_n9+0),_N9))
...
Successfully Proved
d1array14(a9_var, 0, 1) == d1array14(a7_var, 0, 0)
Successfully Proved
Implies((d1array14(a9_var, _k7, _k7 + 1)==d1array14(a7_var, _k7, _k7)),(d1array14(a9_var, _k7 + 1, _k7 + 2)==d1array14(a7_var, _k7 + 1, _k7 + 1)))
Successfully Proved
Implies(ForAll([_n7],Implies(And(And(_n7>=0,_n7<_L7),_L7>0),d1array14(a9_var, _n7, _n7 + 1) == d1array14(a7_var, _n7, _n7))),ForAll([_n7],Implies(And(And(And(And(_n7>=0,_n7<_L7),_L7>0),_n7<_L7+1),_L7>0),d1array14(a9_var, _n7, _n7 + 1) == d1array14(a7_var, _n7, _n7))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array14(a8_var, _x2, 0) == d1array(a8_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array14(a8_var, _x2, _k7 + 1)==d1array(a8_var, _x2)),(d1array14(a8_var, _x2, _k7 + 2)==d1array(a8_var, _x2)))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array16(a8_var, _x2, 0) == d1array(a8_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array16(a8_var, _x2, _k8 + 1)==d1array(a8_var, _x2)),(d1array16(a8_var, _x2, _k8 + 2)==d1array(a8_var, _x2)))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array18(a8_var, _x2, 0) == d1array(a8_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array18(a8_var, _x2, _k9 + 1)==d1array(a8_var, _x2)),(d1array18(a8_var, _x2, _k9 + 2)==d1array(a8_var, _x2)))))
Successfully Proved
...
d1array14(a9_var,(_n7+0),_N7) = d1array14(a7_var,(_n7+0),_N7)
...
d1array16(a8_var,_x2,_N8) = d1array(a8_var,_x2)
...
d1array18(a8_var,_x2,_N9) = d1array(a8_var,_x2)
