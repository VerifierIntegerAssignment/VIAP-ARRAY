>>> prove_auto('standard_copy6_false-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
{}
Local Variables:
{ a7_var:array a3_var:array a1_var:array i:int _1_PROVE:array RET:int a4_var:array a2_var:array a5_var:array x:int a6_var:array}
Program Body
{
  int RET = 0;
  int _1_FAILED = 0;
...
(= i1 (+ _N6 0))
(= x1 (+ _N7 0))
(= (d1array1 _x1 _x2) (d1array14 _x1 _x2 _N7))
(= main 0)
...
(= (d1array10 _x1 _x2 (+ _n5 1)) (ite (and (= _x1 a7_var) (= _x2 (+ _n5 0))) (d1array10 a5_var (+ _n5 0) _n5) (d1array10 _x1 _x2 _n5)))
...
(= (d1array14 _x1 _x2 (+ _n7 1)) (d1array14 _x1 _x2 _n7))
...
d1array10(_x1,_x2,(_n5+1)) = ite(((_x1=a7_var) and (_x2=(_n5+0))),d1array10(a5_var,(_n5+0),_n5),d1array10(_x1,_x2,_n5))
d1array10(_x1,_x2,0) = d1array8(_x1,_x2,_N4)
(_N5>=(-(0)+100000))
...
5. Assertion :
(d1array14(a1_var,(_n7+0),_N7)==d1array14(a7_var,(_n7+0),_N7))
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array10(a6_var, _x2, 0) == d1array(a6_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array10(a6_var, _x2, _k5 + 1)==d1array(a6_var, _x2)),(d1array10(a6_var, _x2, _k5 + 2)==d1array(a6_var, _x2)))))
Successfully Proved
...
Successfully Proved
d1array10(a7_var, 0, 1) == d1array10(a5_var, 0, 0)
Successfully Proved
Implies((d1array10(a7_var, _k5, _k5 + 1)==d1array10(a5_var, _k5, _k5)),(d1array10(a7_var, _k5 + 1, _k5 + 2)==d1array10(a5_var, _k5 + 1, _k5 + 1)))
Successfully Proved
Implies(ForAll([_n5],Implies(And(And(_n5>=0,_n5<_L5),_L5>0),d1array10(a7_var, _n5, _n5 + 1) == d1array10(a5_var, _n5, _n5))),ForAll([_n5],Implies(And(And(And(And(_n5>=0,_n5<_L5),_L5>0),_n5<_L5+1),_L5>0),d1array10(a7_var, _n5, _n5 + 1) == d1array10(a5_var, _n5, _n5))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array12(a6_var, _x2, 0) == d1array(a6_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array12(a6_var, _x2, _k6 + 1)==d1array(a6_var, _x2)),(d1array12(a6_var, _x2, _k6 + 2)==d1array(a6_var, _x2)))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array14(a6_var, _x2, 0) == d1array(a6_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array14(a6_var, _x2, _k7 + 1)==d1array(a6_var, _x2)),(d1array14(a6_var, _x2, _k7 + 2)==d1array(a6_var, _x2)))))
Successfully Proved
...
d1array10(a7_var,(_n5+0),_N5) = d1array10(a5_var,(_n5+0),_N5)
...
d1array12(a6_var,_x2,_N6) = d1array(a6_var,_x2)
...
d1array14(a6_var,_x2,_N7) = d1array(a6_var,_x2)
