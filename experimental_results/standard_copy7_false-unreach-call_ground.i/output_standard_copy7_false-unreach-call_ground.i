>>> prove_auto('standard_copy7_false-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
(= (d1array12 _x1 _x2 (+ _n6 1)) (ite (and (= _x1 a8_var) (= _x2 (+ _n6 0))) (d1array12 a6_var (+ _n6 0) _n6) (d1array12 _x1 _x2 _n6)))
...
d1array12(_x1,_x2,(_n6+1)) = ite(((_x1=a8_var) and (_x2=(_n6+0))),d1array12(a6_var,(_n6+0),_n6),d1array12(_x1,_x2,_n6))
d1array12(_x1,_x2,0) = d1array10(_x1,_x2,_N5)
(_N6>=(-(0)+100000))
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array12(a7_var, _x2, 0) == d1array(a7_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array12(a7_var, _x2, _k6 + 1)==d1array(a7_var, _x2)),(d1array12(a7_var, _x2, _k6 + 2)==d1array(a7_var, _x2)))))
Successfully Proved
...
Successfully Proved
d1array12(a8_var, 0, 1) == d1array12(a6_var, 0, 0)
Successfully Proved
Implies((d1array12(a8_var, _k6, _k6 + 1)==d1array12(a6_var, _k6, _k6)),(d1array12(a8_var, _k6 + 1, _k6 + 2)==d1array12(a6_var, _k6 + 1, _k6 + 1)))
Successfully Proved
Implies(ForAll([_n6],Implies(And(And(_n6>=0,_n6<_L6),_L6>0),d1array12(a8_var, _n6, _n6 + 1) == d1array12(a6_var, _n6, _n6))),ForAll([_n6],Implies(And(And(And(And(_n6>=0,_n6<_L6),_L6>0),_n6<_L6+1),_L6>0),d1array12(a8_var, _n6, _n6 + 1) == d1array12(a6_var, _n6, _n6))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array14(a7_var, _x2, 0) == d1array(a7_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array14(a7_var, _x2, _k7 + 1)==d1array(a7_var, _x2)),(d1array14(a7_var, _x2, _k7 + 2)==d1array(a7_var, _x2)))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array16(a7_var, _x2, 0) == d1array(a7_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array16(a7_var, _x2, _k8 + 1)==d1array(a7_var, _x2)),(d1array16(a7_var, _x2, _k8 + 2)==d1array(a7_var, _x2)))))
Successfully Proved
...
d1array12(a8_var,(_n6+0),_N6) = d1array12(a6_var,(_n6+0),_N6)
...
d1array14(a7_var,_x2,_N7) = d1array(a7_var,_x2)
...
d1array16(a7_var,_x2,_N8) = d1array(a7_var,_x2)
