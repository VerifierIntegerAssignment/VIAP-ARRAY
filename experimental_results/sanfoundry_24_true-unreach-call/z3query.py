...
_s.add(num1 == num)
_s.add(_2DUMMY1 == _2DUMMY)
_s.add(_1DUMMY1 == _1DUMMY)
_s.add(i1 == _N2)
_s.add(main == 0)
_s.add(_N1 >= num)
_s.add(ForAll([_n1],Implies(And(_n1 < _N1,_n1>=0),_f(_n1) < num)))
_s.add(Or(_N1==0,_N1 - 1 < num))
_s.add(_N2 >= num)
_s.add(ForAll([_n2],Implies(And(_n2 < _N2,_n2>=0),_f(_n2) < num)))
_s.add(Or(_N2==0,_N2 - 1 < num))
_s.add(array1 == array)
_s.add(ForAll([_x2,_x1],Implies(_x2>=0,d1array1(_x1, _x2) == d1array(_x1, _x2))))
_s.add(num1 == num)
_s.add(_2DUMMY1 == _2DUMMY)
