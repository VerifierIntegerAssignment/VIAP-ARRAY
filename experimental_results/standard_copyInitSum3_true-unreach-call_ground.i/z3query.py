...
_s.add(ForAll([_n4],Implies(_n4>=0,d1array8(b, _n4, _n4 + 1) == -d1array8(a, _n4, _n4) + d1array8(b, _n4, _n4))))
...
_s.add(ForAll([_n4],Implies(_n4>=0,d1array8(b, _n4, _N4) == -d1array8(a, _n4, _N4) + d1array8(b, _n4, _N4))))
_s.add(ForAll([_n1],Implies(_n1>=0,d1array10(a, _n1, _N5) == 42)))
_s.add(ForAll([_n4],Implies(_n4>=0,d1array10(b, _n4, _N5) == -d1array8(a, _n4, _N4) + d1array8(b, _n4, _N4))))
_s.add(a1 == a)
_s.add(b1 == b)
_s.add(_k1>=0)
_s.add(_k2>=0)
