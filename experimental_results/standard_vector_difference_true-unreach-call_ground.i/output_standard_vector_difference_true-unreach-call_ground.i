>>> file_name='experiment/array-examples/standard_vector_difference_true-unreach-call_ground.i'
...
3. Other axioms:
(= (d1array2 _x1 _x2 (+ _n1 1)) (ite (and (= _x1 c) (= _x2 (+ _n1 0))) (- (d1array2 a (+ _n1 0) _n1) (d1array2 b (+ _n1 0) _n1)) (d1array2 _x1 _x2 _n1)))
...
Successfully Proved
d1array2(c, 0, 1) == d1array2(a, 0, 0) - d1array2(b, 0, 0)
Successfully Proved
Implies((d1array2(c, _k1, _k1 + 1)==d1array2(a, _k1, _k1) - d1array2(b, _k1, _k1)),(d1array2(c, _k1 + 1, _k1 + 2)==d1array2(a, _k1 + 1, _k1 + 1) - d1array2(b, _k1 + 1, _k1 + 1)))
Successfully Proved
Implies(ForAll([_n1],Implies(And(And(_n1>=0,_n1<_L1),_L1>0),d1array2(c, _n1, _n1 + 1) == d1array2(a, _n1, _n1) - d1array2(b, _n1, _n1))),ForAll([_n1],Implies(And(And(And(And(_n1>=0,_n1<_L1),_L1>0),_n1<_L1+1),_L1>0),d1array2(c, _n1, _n1 + 1) == d1array2(a, _n1, _n1) - d1array2(b, _n1, _n1))))
Successfully Proved
...
Successfully Proved
ForAll([_n1],Implies(_n1>=0,d1array4(c, _n1, 0) == d1array2(a, _n1, _N1) - d1array2(b, _n1, _N1)))
Successfully Proved
ForAll([_n1],Implies(_n1>=0,Implies((d1array4(c, _n1, _k2 + 1)==d1array2(a, _n1, _N1) - d1array2(b, _n1, _N1)),(d1array4(c, _n1, _k2 + 2)==d1array2(a, _n1, _N1) - d1array2(b, _n1, _N1)))))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array4(b, _x2, 0) == d1array(b, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array4(b, _x2, _k2 + 1)==d1array(b, _x2)),(d1array4(b, _x2, _k2 + 2)==d1array(b, _x2)))))
Successfully Proved
...
d1array4(c,(_n1+0),_N2) = (d1array2(a,(_n1+0),_N1)-d1array2(b,(_n1+0),_N1))
