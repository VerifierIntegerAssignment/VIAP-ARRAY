>>> prove_auto('standard_copyInitSum2_true-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
Successfully Proved
ForAll([_n3],Implies(_n3>=0,d1array8(b, _n3, 0) == _n3 + d1array6(b, _n3, _N3)))
Successfully Proved
ForAll([_n3],Implies(_n3>=0,Implies((d1array8(b, _n3, _k4 + 1)==_n3 + d1array6(b, _n3, _N3)),(d1array8(b, _n3, _k4 + 2)==_n3 + d1array6(b, _n3, _N3)))))
Successfully Proved
...
d1array8(b,(_n3+0),_N4) = (d1array6(b,(_n3+0),_N3)+(_n3+0))
