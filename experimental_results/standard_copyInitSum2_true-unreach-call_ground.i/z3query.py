...
_s.add(ForAll([_n3],Implies(_n3>=0,d1array6(b, _n3, _n3 + 1) == _n3 + d1array6(b, _n3, _n3))))
...
_s.add(ForAll([_n3],Implies(_n3>=0,d1array6(b, _n3, _N3) == _n3 + d1array6(b, _n3, _N3))))
_s.add(ForAll([_n1],Implies(_n1>=0,d1array8(a, _n1, _N4) == 42)))
_s.add(ForAll([_n3],Implies(_n3>=0,d1array8(b, _n3, _N4) == _n3 + d1array6(b, _n3, _N3))))
_s.add(a1 == a)
_s.add(b1 == b)
_s.add(_k1>=0)
_s.add(_k2>=0)
