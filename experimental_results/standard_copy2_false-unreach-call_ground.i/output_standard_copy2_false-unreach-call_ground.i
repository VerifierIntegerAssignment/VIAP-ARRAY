>>> prove_auto('standard_copy2_false-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
{}
Local Variables:
{ a3_var:array a1_var:array i:int _1_PROVE:array RET:int a2_var:array x:int}
Program Body
{
  int RET = 0;
  int _1_FAILED = 0;
...
3. Other axioms:
(= (d1array2 _x1 _x2 (+ _n1 1)) (ite (and (= _x1 a3_var) (= _x2 (+ _n1 0))) (d1array2 a1_var (+ _n1 0) _n1) (d1array2 _x1 _x2 _n1)))
...
3. Other axioms:
d1array2(_x1,_x2,(_n1+1)) = ite(((_x1=a3_var) and (_x2=(_n1+0))),d1array2(a1_var,(_n1+0),_n1),d1array2(_x1,_x2,_n1))
d1array2(_x1,_x2,0) = d1array(_x1,_x2)
(_N1>=(-(0)+100000))
...
5. Assertion :
(d1array6(a1_var,(_n3+0),_N3)==d1array6(a3_var,(_n3+0),_N3))
...
Successfully Proved
d1array2(a3_var, 0, 1) == d1array2(a1_var, 0, 0)
Successfully Proved
Implies((d1array2(a3_var, _k1, _k1 + 1)==d1array2(a1_var, _k1, _k1)),(d1array2(a3_var, _k1 + 1, _k1 + 2)==d1array2(a1_var, _k1 + 1, _k1 + 1)))
Successfully Proved
Implies(ForAll([_n1],Implies(And(And(_n1>=0,_n1<_L1),_L1>0),d1array2(a3_var, _n1, _n1 + 1) == d1array2(a1_var, _n1, _n1))),ForAll([_n1],Implies(And(And(And(And(_n1>=0,_n1<_L1),_L1>0),_n1<_L1+1),_L1>0),d1array2(a3_var, _n1, _n1 + 1) == d1array2(a1_var, _n1, _n1))))
Successfully Proved
...
Successfully Proved
ForAll([_x2],Implies(_x2>=0,d1array6(a2_var, _x2, 0) == d1array(a2_var, _x2)))
Successfully Proved
ForAll([_x2],Implies(_x2>=0,Implies((d1array6(a2_var, _x2, _k3 + 1)==d1array(a2_var, _x2)),(d1array6(a2_var, _x2, _k3 + 2)==d1array(a2_var, _x2)))))
Successfully Proved
...
d1array2(a3_var,(_n1+0),_N1) = d1array2(a1_var,(_n1+0),_N1)
...
d1array6(a2_var,_x2,_N3) = d1array(a2_var,_x2)
