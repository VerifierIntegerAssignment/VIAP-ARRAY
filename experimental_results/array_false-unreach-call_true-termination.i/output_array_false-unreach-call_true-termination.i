>>> prove_auto('array_false-unreach-call_true-termination.i')
Program Body
{
  int RET = 0;
  int _1_PROVE = 0;
...
[__VERIFIER_nondet_int = 0,
 ...
 j1 = 1,
 k = 22,
 array1 = arraySort!val!0,
 menor1 = 0,
 k1 = 22,
 _N1 = 1,
 array = arraySort!val!0,
 main = 0,
 menor4 = [else -> 0],
 _f = [else -> Var(0)],
 d1array4 = [else -> 0],
 d1array1 = [(arraySort!val!0, 0) -> 0,
             else -> d1array4(Var(0), Var(1), 1)],
 d1array = [else -> d1array4(Var(0), Var(1), 0)]]
