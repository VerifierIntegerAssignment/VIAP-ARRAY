>>> prove_auto('standard_init2_false-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
Successfully Proved
ForAll([_n2],Implies(_n2>=0,d1array6(a, _n2, 0) == 43))
Successfully Proved
ForAll([_n2],Implies(_n2>=0,Implies((d1array6(a, _n2, _k3 + 1)==43),(d1array6(a, _n2, _k3 + 2)==43))))
Successfully Proved
