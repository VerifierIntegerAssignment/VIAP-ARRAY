...
_s.add(i1 == _N1)
_s.add(x1 == _N2)
_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(dst, _x2) == d1array4(dst, _x2, _N2))))
_s.add(main == 0)
_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(src, _x2) == d1array4(src, _x2, _N2))))
_s.add(ForAll([_x2,_n1],Implies(And(_x2>=0,_n1>=0),d1array2(src, _x2, _n1 + 1) == d1array2(src, _x2, _n1))))
_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(dst, _n1, _n1 + 1) == d1array2(src, _n1, _n1))))
...
_s.add((d1array2(src, _N1, _N1)==0))
_s.add(ForAll([_n1],Implies(And(_n1 < _N1,_n1>=0),(d1array2(src, _f(_n1), _f(_n1))!=0))))
_s.add(Or(_N1==0,(d1array2(src, _N1 - 1, _N1 - 1)!=0)))
