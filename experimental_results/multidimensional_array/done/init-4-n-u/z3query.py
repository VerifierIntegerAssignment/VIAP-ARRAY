...
_n6=Int('_n6')
j1=Int('j1')
d3array16=Function('d3array16',arraySort,IntSort(),IntSort(),IntSort(),IntSort(),IntSort(),IntSort(),IntSort(),IntSort())
d3array19=Function('d3array19',arraySort,IntSort(),IntSort(),IntSort(),IntSort(),IntSort(),IntSort(),IntSort())
...
d3array28=Function('d3array28',arraySort,IntSort(),IntSort(),IntSort(),IntSort(),IntSort())
k14=Function('k14',IntSort(),IntSort())
l14=Function('l14',IntSort(),IntSort())
d3array23=Function('d3array23',arraySort,IntSort(),IntSort(),IntSort(),IntSort(),IntSort(),IntSort())
...
_s.add(l1 == l28(_N8))
_s.add(main == 0)
_s.add(ForAll([_x3,_x2,_x5,_x4],Implies(And(_x3>=0,And(_x2>=0,And(_x5>=0,_x4>=0))),d4array1(A, _x2, _x3, _x4, _x5) == d4array14(A, _x2, _x3, _x4, _x5, _N4))))
...
_s.add(ForAll([_n2],Implies(_n2>=0,_n2 >= p)))
_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n1 < _N1(_n2, _n3, _n4),And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0)))),_f(_n2) < p)))
_s.add(ForAll([_n4,_n3,_n2],Implies(And(_n4>=0,And(_n3>=0,_n2>=0)),Or(_N1(_n2, _n3, _n4)==0,_n2 < p))))
...
_s.add(ForAll([_n6],Implies(_n6>=0,_n6 >= p)))
_s.add(ForAll([_n5,_n7,_n6,_n8],Implies(And(_n5 < _N5(_n6, _n7, _n8),And(_n5>=0,And(_n7>=0,And(_n6>=0,_n8>=0)))),_f(_n6) < p)))
_s.add(ForAll([_n7,_n6,_n8],Implies(And(_n7>=0,And(_n6>=0,_n8>=0)),Or(_N5(_n6, _n7, _n8)==0,_n6 < p))))
...
_s.add(ForAll([_x3,_x2,_x5,_x4,_n4,_n1,_n3,_n2],Implies(And(_x3>=0,And(_x2>=0,And(_x5>=0,And(_x4>=0,And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))))))),d4array5(A, _n4, _n3, _n2, _n1, _N2(_n3, _n4), _n3, _n4) == d4array(A, _x2, _x3, _x4, _x5))))
_s.add(ForAll([_x3,_x2,_x5,_x4,_n4,_n1,_n3,_n2],Implies(And(_x3>=0,And(_x2>=0,And(_x5>=0,And(_x4>=0,And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))))))),d4array9(A, _n4, _n3, _n2, _n1, _N3(_n4), _n4) == d4array(A, _x2, _x3, _x4, _x5))))
_s.add(ForAll([_x3,_x2,_x5,_x4,_n4,_n1,_n3,_n2],Implies(And(_x3>=0,And(_x2>=0,And(_x5>=0,And(_x4>=0,And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))))))),d4array14(A, _n4, _n3, _n2, _n1, _N4) == d4array(A, _x2, _x3, _x4, _x5))))
_s.add(A1 == A)
_s.add(C1 == C)
_s.add(m1 == m)
_s.add(n1 == n)
