>>> prove_auto('standard_init8_false-unreach-call_ground.i')
Program Body
{
  int RET = 0;
  int _1_PROVE[];
...
Successfully Proved
ForAll([_n8],Implies(_n8>=0,d1array18(a, _n8, 0) == 49))
Successfully Proved
ForAll([_n8],Implies(_n8>=0,Implies((d1array18(a, _n8, _k9 + 1)==49),(d1array18(a, _n8, _k9 + 2)==49))))
Successfully Proved
